...
[![](https://img.shields.io/github/issues-pr-closed-raw/ichont/DMU-Course-Help.svg?style=flat)](https://github.com/ichont/DMU-Course-Help/issues)
![](https://img.shields.io/github/repo-size/ichont/DMU-Course-Help.svg?style=flat)
[![contributors](https://img.shields.io/github/forks/ichont/DMU-Course-Help.svg?style=flat)](https://github.com/ichont/DMU-Course-Help/network/members)
...
受[`清华大学计算机系课程攻略`](https://github.com/PKUanonym/REKCARC-TSC-UHT) 和 [`浙江大学课程攻略共享计划`](https://github.com/QSCTech/zju-icicles) 和 [`上海交通大学课程攻略`](https://github.com/kxxwz/SJTU-Courses?tab=readme-ov-file)  等项目启发，我们决定将**大连海事大学**信息学院课程的历年资料整理出来，以利后人。上述两项目对本资料集有重要影响，在这里向他们表示感谢。

仓库为继承并搜集往届学长所得，并增添新的内容**想共同深入探讨，或共同贡献维护仓库内容请联系我！**
...
2. 资料完全为自己整理搜集，仅供参考，请自己判断适用性。
3. 本项目已设置开源许可，**禁止**下载用于一切商业活动获利。
4. 部分资料已经有些年头，如果大家手头有更好的资料，敬请 PR。
5. 如果大家发现资料中的问题，请不要犹豫，直接提出 issue, 我们会尽快修改。
6. 在 PR 时，建议上传 pdf 文件。推荐使用 Adobe Acrobat 进行 doc/docx 文件的转换。
